---
name: casa-guardian
description: Audits a change for violations of the rule that no Google Drive data may reach a server. Use before committing anything that touches Drive API calls, backend requests, or logging in extension code.
